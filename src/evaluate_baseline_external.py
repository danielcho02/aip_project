...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Evaluate baseline CNN on Kaggle validation and RSNA external validation."
    )
    ...
    parser.add_argument("--out_dir", default="outputs/baseline_external", help="Output directory.")
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="RSNA samples per class for fast external validation. Use 100 or 200 for a quick test.",
    )
