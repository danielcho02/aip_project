...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a baseline CNN on Kaggle chest X-ray split CSV.")
    parser.add_argument("--csv_path", required=True, help="Path to split CSV.")
    parser.add_argument("--out_dir", default="outputs/baseline", help="Output directory.")
...
def main():
    ...
    best_auc = -math.inf
    best_checkpoint_path = out_dir / f"best_baseline_seed{args.seed}.pt"
