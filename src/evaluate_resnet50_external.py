...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Evaluate ResNet50 on Kaggle validation and RSNA external validation."
    )
    parser.add_argument("--checkpoint", required=True, help="Path to trained ResNet50 checkpoint.")
    ...
    parser.add_argument("--out_dir", default="outputs/resnet50_external", help="Output directory.")
...
def load_resnet50_model(checkpoint_path, device):
...
def main():
    ...
    model = load_resnet50_model(args.checkpoint, device)
